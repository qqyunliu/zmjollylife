 ...
 */public class Infoquery extends BaseQuery {
	...
	private String lastLoginTimeEed;
	...
	public void setJoinTimeEed(String joinTimeEed) {
		this.joinTimeEed = joinTimeEed;
	}

	public String getJoinTimeEed() {
		return this.joinTimeEed;
	}
	...
	public void setLastLoginTimeEed(String lastLoginTimeEed) {
		this.lastLoginTimeEed = lastLoginTimeEed;
	}

	public String getLastLoginTimeEed() {
		return this.lastLoginTimeEed;
	}
